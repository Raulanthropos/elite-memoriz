...
export const paymentPurchases = pgTable(
  'payment_purchases',
  {
    ...
    paymentMethodType: text('payment_method_type').default('card').notNull(),
    everypayPaymentToken: text('everypay_payment_token').unique(),
    everypayCustomerEmail: text('everypay_customer_email'),
